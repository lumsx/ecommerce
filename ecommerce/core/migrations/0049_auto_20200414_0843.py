# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-04-14 08:43
...
def populate_default_site_configurations(apps, schema_editor):
    site_configurations = apps.get_model('core', 'siteconfiguration')
    for site_configuration in site_configurations.objects.all():
        if not site_configuration.edly_client_theme_branding_settings:
            site_configuration.edly_client_theme_branding_settings = DEFAULT_EDLY_CLIENT_THEME_CONFIGURATION
            site_configuration.save()


class Migration(migrations.Migration):
    dependencies = [
        ('core', '0048_siteconfiguration_edly_client_theme_branding_settings'),
    ]
